...
PreparedStatement pst = null;
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(78, 108, 80));

        jLabel4.setBackground(new java.awt.Color(78, 108, 80));
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/loginjava/logo.png"))); // NOI18N
        jLabel4.setText("jLabel4");

        jPanel1.setBackground(new java.awt.Color(57, 81, 68));
        jPanel1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel1.setForeground(new java.awt.Color(170, 139, 86));
        ...
        jname.setBackground(new java.awt.Color(240, 235, 206));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(170, 139, 86));
        jLabel3.setText("Password:");

        jpass.setBackground(new java.awt.Color(240, 235, 206));
        ...
        jLabel8.setText("Don't Have An Account? Register Now");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if (rs.next()){
                JOptionPane.showMessageDialog(rootPane,"User " + un + " is successfully login....");
